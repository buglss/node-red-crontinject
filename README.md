...
It is an extended clone of core inject node with [cronjo](https://www.npmjs.com/package/cronjo) package. The [cronjo](https://www.npmjs.com/package/cronjo) package also uses the [cronti](https://www.npmjs.com/package/cronti) package.
